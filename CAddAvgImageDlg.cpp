...
// CAddAvgImageDlg 대화 상자

IMPLEMENT_DYNAMIC(CAddAvgImageDlg, CDialogEx)

CAddAvgImageDlg::CAddAvgImageDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_ADDAVG, pParent)
...
void CAddAvgImageDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Radio(pDX, IDC_FUNCTIONADD, m_nFunction);
}


BEGIN_MESSAGE_MAP(CAddAvgImageDlg, CDialogEx)
	ON_CBN_SELCHANGE(IDC_COMBO_IMAGE2, &CAddAvgImageDlg::OnCbnSelchangeComboImage2)
	ON_BN_CLICKED(IDOK, &CAddAvgImageDlg::OnBnClickedOk)
END_MESSAGE_MAP()


// CAddAvgImageDlg 메시지 처리기


void CAddAvgImageDlg::OnCbnSelchangeComboImage2()
{
